...
export async function POST(_request: Request) {
  ...
  console.log(
    ...
    "expected:",
    JSON.stringify({ sum: 9, product: 14, combined: 23 })
  );
  ...
  console.log(
    ...
    "expected:",
    JSON.stringify("finalized:prepared:test-input")
  );
  ...
  console.log(
    ...
    "expected:",
    JSON.stringify("done:finalized:prepared:multi")
  );
  ...
  console.log(
    ...
    "expected:",
    JSON.stringify({ status: "approved", reviewer: "alice" })
  );
  ...
  console.log(
    ...
    "expected:",
    JSON.stringify({ status: "rejected", reviewer: "bob" })
  );
